...
class SpriteSheet:
    ...
    def __init__(self, sheet, width, height, rowNums=0):
        ...
        # temp animation is used to splice multiple sets of an animation and append them to one lise
        # this list can then be returned to for instance be set to a walking list
        # this list will then be emptied
        self.tempAnimations = []
